...
.DB "8CECPck"
.ORG 7
.DB "1B3X-ZX7",0  ;1bpp black/white 3x scale zx7 decoder
.ORG 16
.DB 2
;NOTE: VRAM STARTS AT $D40000
#DEFINE INITIAL_FIELD_LOCATION $D48000   ;MAIN FIELD LOCATION
#DEFINE MAIN_FIELD_LOCATION $D4A000      ;CHANGE LATER TO $E30800 IF SMALL ENOUGH.
#DEFINE DECOMPRESSION_BUFFER $D52000
#DEFINE BUFFER1 $D40000  ;GIVE IT 16KB to store 9600 bytes
#DEFINE BUFFER2 $D44000  ;ANOTHER 16KB 
...
;END OF FILE
.ECHO "Assembling decoder 1B3X-ZX7"
