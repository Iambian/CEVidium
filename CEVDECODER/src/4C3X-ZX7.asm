...
.DB "8CECPck"
.ORG 7
.DB "4C3X-ZX7",0  ;4bpp fixed color palette 3x scale zx7 decoder
.ORG 16
.DB 2
;NOTE: VRAM STARTS AT $D40000
#DEFINE BUFFER1 $D40000  ;GIVE IT 16KB to store 9600 bytes
#DEFINE BUFFER2 $D49600  ;ANOTHER 16KB 
#DEFINE MAIN_FIELD_LOCATION $D53000      ;CHANGE LATER TO $E30800 IF SMALL ENOUGH.
...
;END OF FILE
.ECHO "Assembling decoder 4C3X-ZX7"
