...
#DEFINE INITIAL_FIELD_LOCATION $D3B000   ;MAIN FIELD LOCATION
#DEFINE MAIN_FIELD_LOCATION $D3D000      ;CHANGE LATER TO $E30800 IF SMALL ENOUGH.
#DEFINE DECOMPRESSION_BUFFER $D40000
...
#DEFINE BUFFER1 $D30000  ;GIVE IT 20KB to store 19200 bytes
#DEFINE BUFFER2 $D35000  ;ANOTHER 20KB 
